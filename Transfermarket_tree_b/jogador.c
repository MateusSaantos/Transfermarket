...
/*int cmp_cliente(TPlayer *c1, TPlayer *c2)
{
    if (c1 == NULL && c2 == NULL) {
        return 1; // São considerados iguais se ambos forem NULL
    }
    if (c1 == NULL || c2 == NULL) {
        return 0; // São considerados diferentes se apenas um deles for NULL
    }

    // Compare os campos relevantes dos jogadores
    if (c1->id != c2->id) {
        return 0;
    }
    ...
    if (strcmp(c1->posicao, c2->posicao) != 0) {
        return 0;
    }
    ...
    if (c1->valorMercado != c2->valorMercado) {
        return 0;
    }
    if (c1->score != c2->score) {
        return 0;
    }
    if (strcmp(c1->contrato, c2->contrato) != 0) {
        return 0;
    }
    // Compare os campos da estrutura TClub (clube) se necessário

    return 1; // São considerados iguais se todos os campos forem iguais
}*/
